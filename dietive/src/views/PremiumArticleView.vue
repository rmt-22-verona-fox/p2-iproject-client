  ...
  <div>
    <main class="main">
      <div class="responsive-wrapper">
        ...
        <div class="content-header">
          <div class="content-header-intro">
            ...
            <p v-if="state === 'regular'">
              Please update to read our article
            </p>
            <p v-if="state === 'premium'">
              Happy reading!
            </p>
          </div>
        </div>
      ...
      <div v-if="state === 'regular'">
        ...
        <div class="content-main" style="width:900px; margin-right: 100px"  v-if="state === 'premium'">
          <div class="card-grid">
            <article class="card" v-for="data in allArticles" :key="data.id">
              <div class="card-header">
                <div>
                  <img style="width: 300px; height: 200px; object-fit: cover" :src="data.urlToImage" />
                </div>
              </div>
              <div></div>
              <div class="card-body">
