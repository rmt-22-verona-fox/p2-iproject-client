      ...
      <form @submit.prevent="submitPost" class="bg-white p-10 rounded-lg shadow-lg min-w-full">
        ...
        <div>
          ...
          <input
            ...
            @change="getImage"
            class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none"
            placeholder="format.jpg"
          />
        </div>
        <div>
          <label class="text-gray-800 font-semibold block my-3 text-md" for="confirm"
            >Description Your Service</label
          >
          <input
            v-model="description"
            class="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none"
            type="text"
            placeholder="bisa benerin genteng dengan sangat cepat"
          />
        </div>
        <button
          type="submit"
